...
self.addEventListener('message', (e) => {
  ...
  try {
    ...
    self.importScripts('{{ "https://cdn.jsdelivr.net/gh/TechlySeries/mydo/beutify.min.js" | relative_url }}');
  ...
  try {
    self.importScripts('{{ "https://cdn.jsdelivr.net/gh/TechlySeries/mydo/highlight.min.js" | relative_url }}');
